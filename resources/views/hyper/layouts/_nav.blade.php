        ...
        <ul class="list-unstyled topbar-right-menu float-right mb-0">
            <li class="notification-list">
                <a class="nav-link right-bar-toggle" href="https://chatgpt.567bus.shop/"  target="_blank">
                    <i class="noti-icon mdi mdi-cow">::before</i>
                    本站免费ChatGpt
                </a>
            </li>
            ...
            <li class="notification-list">
                <a class="nav-link right-bar-toggle" href="https://t.me/bus567buhuotz" target="_blank">
                    <i class="noti-icon mdi mdi-bell-outline">::before</i>
                    补货通知
                </a>
            </li>
            ...
            <li class="notification-list">
                <a class="nav-link right-bar-toggle" href="https://t.me/bus5678" target="_blank">
                    <i class="noti-icon mdi mdi-telegram">::before</i>
                    官方群组
                </a>
            </li>
            ...
            <li class="notification-list">
                <a class="nav-link right-bar-toggle" href="https://www.567bus.shop/order-search">
                    <i class="noti-icon mdi mdi-magnify search-icon">::before</i>
                    查询订单
                </a>
            </li>
